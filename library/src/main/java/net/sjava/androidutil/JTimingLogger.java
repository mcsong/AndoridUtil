...
public class JTimingLogger {
     ...
     */
    public JTimingLogger(String tag, String label) {
        reset(tag, label);
    }
     ...
     */
    public void reset() {
        mDisabled = !Log.isLoggable(mTag, mLogLevel);
        if (mDisabled) return;
    ...
    public void addSplit(String splitLabel) {
        ...
        mSplits.add(SystemClock.elapsedRealtime());
